...
describe("Walkthrough Mermaid binding validation", () => {
  it.each([
    {
      diagram: "flowchart",
      source: ["flowchart LR", "  Controller[Controller] --> Service[Service]"].join("\n"),
    ...
    },
    {
      ...
      expected: ["USER", "ORDER", "ITEM", "AUDIT", "LOG"],
      excluded: ["places", "contains", "records", "emits"],
    },
    {
