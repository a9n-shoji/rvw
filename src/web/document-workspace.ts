...
export type ActiveDocument =
  ...
  | { kind: "structure-spike"; id: string; title: string; sourceOid: string }
  | {
...
export function documentTabPath(document: ActiveDocument): string {
  ...
  if (document.kind === "structure-spike") return document.title;
...
export function currentCommitDocument(document: ActiveDocument): ActiveDocument {
  ...
  if (document.kind === "walkthrough" || document.kind === "structure-spike") return document;
