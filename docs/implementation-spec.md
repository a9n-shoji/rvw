...
- 連続commit range picker、全文／変更、diff style、`Hide Whitespace` checkboxは最上部top bar内へ置く。range pickerは
...
最上部のtop barにPR情報と、repository全体へ作用するcommit範囲、表示、diff style、`Hide Whitespace` checkboxを並べる。
